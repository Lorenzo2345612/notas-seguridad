...
r = remote("saturn.picoctf.net", 61615)
...
1. Se conecta a un servidor remoto.
2. Recibe el mensaje cifrado y la clave privada `d`.
3. Intenta encontrar los factores primos de `n` (el módulo RSA) usando la clave privada `d` y una técnica de factorización parcial.
4. Una vez que encuentra los factores primos, intenta descifrar el mensaje utilizando cada combinación posible de estos factores.
5. Envía los mensajes descifrados al servidor hasta encontrar uno que parezca ser legible.
...
https://www.youtube.com/watch?v=3DPWLnrqHZ0&ab_channel=MartinCarlisle