...
bandit22@bandit:/etc/cron.d$ echo "I am usertmp" | md5sum | cut -d ' ' -f 1
22f0b08cd4e7b595cfe8eccd51c94668
...
```
## Notas adicionales
Aprender bash script es importante para entender que hacen los procesos en segundo plano.
## Referencias