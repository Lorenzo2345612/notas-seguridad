...
```
lorenzo@LAPTOP-1F71H10Q:~/MGM$ ssh ctf-player@venus.picoctf.net -p 55131
The authenticity of host '[venus.picoctf.net]:55131 ([3.131.124.143]:55131)' can't be established.
ED25519 key fingerprint is SHA256:P1f6h95BrSVnJbm2AKhphfHHGEyAeThib/rN/AwKs24.
This host key is known by the following other names/addresses:
    ~/.ssh/known_hosts:4: [hashed name]
Are you sure you want to continue connecting (yes/no/[fingerprint])? yes
Warning: Permanently added '[venus.picoctf.net]:55131' (ED25519) to the list of known hosts.
...
drwxr-xr-x 1 ctf-player ctf-player 4096 Mar  3 03:56 ..
...
ctf-player@pico-chall$ ls -la
total 92
drwxr-xr-x   1 root root 4096 Mar  3 03:55 .
drwxr-xr-x   1 root root 4096 Mar  3 03:55 ..
-rwxr-xr-x   1 root root    0 Mar  3 03:55 .dockerenv
-rw-r--r--   1 root root   17 Mar 16  2021 2of3.flag.txt
drwxr-xr-x   1 root root 4096 Mar 16  2021 bin
drwxr-xr-x   2 root root 4096 Apr 24  2018 boot
drwxr-xr-x   5 root root  340 Mar  3 03:55 dev
drwxr-xr-x   1 root root 4096 Mar  3 03:55 etc
...
dr-xr-xr-x 182 root root    0 Mar  3 03:55 proc
drwx------   2 root root 4096 Feb 22  2021 root
drwxr-xr-x   1 root root 4096 Mar  3 03:56 run
drwxr-xr-x   1 root root 4096 Mar 16  2021 sbin
drwxr-xr-x   2 root root 4096 Feb 22  2021 srv
dr-xr-xr-x  13 root root    0 Mar  3 03:55 sys
...
**ssh**: es un comando que nos ayuda a crear una conexión segura con un servidor.
## Referencias